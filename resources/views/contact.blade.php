...
<body class="w-full h-auto bg-cover flex flex-col bg-stone-300 bg-no-repeat font-inter">
    ...
    <div class="w-full h-20 flex items-start justify-start">
        <div class="w-3/4 h-full px-8">
            <h1 class="font-scoville text-4xl">Let's Build Something Great Together!</h1>
        </div>
    </div>
    <div class="w-full h-auto flex px-8">
        <div class="basis-3/4 h-full">
            ...
            <h2 class="font-scoville my-4 text-4xl font-bold text-black dark:text-white">Get in Touch</h2>
            
        </div>
        <div class="basis-1/4">
            <img class="h-1/4 max-w-lg" src="{{ asset('storage/images/contact.png') }}" alt="">
        </div>
    </div>
