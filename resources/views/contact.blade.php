...
<body class="w-full h-dvh bg-cover flex flex-col bg-stone-300 bg-no-repeat font-inter">
    ...
    <div class="w-full h-20 flex items-center justify-center">
        <div class="w-3/4 h-full px-8 text-center">
            <h1 class="font-montbold text-5xl">Let's Build Something Great Together!</h1>
        </div>
    </div>
    <div class="w-full h-auto flex grow px-8">
        <div class="basis-1/2 h-full ">
            <p class=" text-black text-2xl mt-8">
        ...
        <div class="basis-1/2">
            <h2 class="font-montbold  text-4xl font-bold text-black dark:text-white">Say Hello👋</h2>
            <p class="text-4xl my-7 font-bold"><a href="mailto:hello@htetpyaeaung.dev?subject=Let's Collaborate">hello@htetpyaeaung.dev</a>
            </p>
            <div class="decoratedHeading"><span>Or</span></div>
            <h2 class="font-montbold text-4xl font-bold text-black dark:text-white">Connect with me on socials</h2>
