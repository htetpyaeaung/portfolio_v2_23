...
<div class="w-full h-full flex flex-col xxs:mt-24 lg:mt-28" id="projects">
  ...
  <div class="flex mx-auto xxs:w-11/12 lg:w-10/12 p-4 text-center xxs:justify-center items-center lg:justify-end bg-white shadow-2xl mt-9 project-item" id="firstPJ">
    <div class="flex items-center text-center flex-col xxs:justify-end lg:justify-center xxs:w-3/4 xxs:h-4/5 lg:w-2/5 lg:h-2/4">
        <h2 class="xxs:text-2xl lg:text-3xl font-extrabold">Middleware at Cara</h2>
        <p>Transactional Middleware</p>
        <div class="w-full h-auto mx-auto flex items-center justify-center">
